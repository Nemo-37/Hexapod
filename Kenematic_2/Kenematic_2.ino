...
//MSS.servoWrite(10, 160);  //5
  ...
  for (float pos5 = 40, pos6 = 0, pos7 = 0; pos5 <= 90; pos5 += 1, pos6 += 0.2, pos7 += 0.6) {  //сгибание середина лево 1
    
MSS.servoWrite(9, 180 - pos5);    //4
MSS.servoWrite(10, 110 + pos6);  //5
MSS.servoWrite(11, 60 + pos7);   //6


    delay(30);  
  }

  for (float pos5 = 40, pos6 = 0, pos7 = 0; pos5 <= 90; pos5 += 1, pos6 += 0.2, pos7 += 0.6) {  //разгибание середина лево 2
