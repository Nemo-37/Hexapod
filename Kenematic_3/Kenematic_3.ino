...
//MSS.servoWrite(10, 160);  //5
  ...
  for (float pos3 = 0, pos4 = 0, pos5 = 0; pos3 <= 40; pos3 += 1, pos4 += 0.25, pos5 += 0.5) {  //сгибание середина лево 1
  ...
  for (float pos3 = 40, pos4 = 0, pos5 = 0; pos3 <= 90; pos3 += 1, pos4 += 0.2, pos5 += 0.6) {  //разгибание середина лево 2
