...
//MSS.servoWrite(10, 160);  //5
  ...
  for (float pos3 = 0, pos4 = 0, pos8 = 0; pos3 <= 40; pos3 += 1, pos4 += 0.25, pos8 += 0.5) {  //сгибание середина лево 1
    
  MSS1.servoWrite(2, 40 + pos3);   //7. 90 130
  MSS1.servoWrite(1, 70 - pos4);  //8. 120 110
  MSS1.servoWrite(0, 70 + pos8);   //9. 90 110


    delay(30);  
  }

  for (float pos3 = 40, pos4 = 0, pos8 = 0; pos3 <= 90; pos3 += 1, pos4 += 0.2, pos8 += 0.6) {  //разгибание середина лево 2
    
  MSS1.servoWrite(2, 80);   //7. 90 130
  ...
  MSS1.servoWrite(2, 40);   //7. 90 130
  MSS1.servoWrite(1, 20);  //8. 120 110
  MSS1.servoWrite(0, 90);
